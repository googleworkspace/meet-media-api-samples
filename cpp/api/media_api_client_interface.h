...
#ifndef CPP_API_MEDIA_API_CLIENT_INTERFACE_H_
#define CPP_API_MEDIA_API_CLIENT_INTERFACE_H_
...
struct AudioFrame {
  ...
  /// Absolute capture timestamp in milliseconds of the audio frame.
...
#endif  // CPP_API_MEDIA_API_CLIENT_INTERFACE_H_
