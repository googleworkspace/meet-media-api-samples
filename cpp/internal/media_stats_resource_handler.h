...
#ifndef CPP_INTERNAL_MEDIA_STATS_RESOURCE_HANDLER_H_
#define CPP_INTERNAL_MEDIA_STATS_RESOURCE_HANDLER_H_
...
class MediaStatsResourceHandler : public ResourceHandlerInterface {
 public:
...
#endif  // CPP_INTERNAL_MEDIA_STATS_RESOURCE_HANDLER_H_
