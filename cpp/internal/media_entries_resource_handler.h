...
#ifndef CPP_INTERNAL_MEDIA_ENTRIES_RESOURCE_HANDLER_H_
#define CPP_INTERNAL_MEDIA_ENTRIES_RESOURCE_HANDLER_H_
...
#endif  // CPP_INTERNAL_MEDIA_ENTRIES_RESOURCE_HANDLER_H_
