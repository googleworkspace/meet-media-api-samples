...
#ifndef CPP_INTERNAL_PARTICIPANTS_RESOURCE_HANDLER_H_
#define CPP_INTERNAL_PARTICIPANTS_RESOURCE_HANDLER_H_
...
class ParticipantsResourceHandler : public ResourceHandlerInterface {
 public:
...
#endif  // CPP_INTERNAL_PARTICIPANTS_RESOURCE_HANDLER_H_
